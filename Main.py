...
TELEGRAM_BOT_TOKEN = os.getenv("8824963965:AAFtESw6niqh7FsgGrKyUotv-5x8o0lqFLw")
TELEGRAM_CHAT_ID = os.getenv("7113872351")

if not TELEGRAM_BOT_TOKEN or not TELEGRAM_CHAT_ID:
    raise ValueError("Missing TELEGRAM_BOT_TOKEN or TELEGRAM_CHAT_ID environment variables, baby. 6767")
